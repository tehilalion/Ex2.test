...
public class Map implements Map2D, Serializable{
    ...
    /**
     * Initializes the map with width w, height h, and initial value v
    ...
    /**
     *Initializes the map with a copy of a given 2D array.
    ...
    /**
     * Returns the value of the pixel at a given Pixel2D
    ...
    /**
     * Sets the value of a pixel at (x,y).
     * @param x the x coordinate
     * @param y the y coordinate
    ...
    /**
     * Sets the value of a pixel at a given Pixel2D.
    ...
    /**
     * checks if cooridinates (x,y) are inside the map boundaries
     * @param x
     * @param y
     * @return
     */
    ...
    /**
     * Checks if a Pixel2D is inside the map boundaries.
    ...
    /**
     * Checks if this map has the same dimensions as another map.
     * @param p
     * @return
     */
    @Override
    ...
    /**
     * adds the values of another map to this map
    ...
    /**
     * Rescales the map by sx horizontally and sy vertically.
     * @param sx
     * @param sy
     */
    ...
    /**
     * Draws a filled circle at a given center with a specified radius and color.
     * @param center
     * @param rad
...
private void drawHorizontalLine(Pixel2D p1, Pixel2D p2, int color) {
    ...
    /**
     *      * Computes distance from start to all reachable pixels, avoiding obstacles.
